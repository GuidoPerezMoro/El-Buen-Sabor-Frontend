...
interface CardArticuloSeleccionadoProps {
    onAgregarArticulo: (idArticulo: number, cantidad: number, denominacion: string) => void;
}


const CardArticuloSeleccionado: React.FC<CardArticuloSeleccionadoProps> = ({ onAgregarArticulo }) => {
        ...
        <>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                ...
                <Button variant='contained' onClick={handleAgregarArticulo} sx={{
                    bgcolor: '#E66200', borderColor: '#E66200', "&:hover": {
                        bgcolor: "grey",
                    }
                }}>
                    Agregar Artículo
...
export default CardArticuloSeleccionado;